...
import { SERVICES } from "@/lib/marketing/clinic";
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-lg leading-relaxed text-pretty text-ink-soft">
            Cada área de atendimento tem sua própria ficha de avaliação e um plano de tratamento
            personalizado.
          </p>
        </div>
          ...
          {filtered.map((service) => (
            ...
            >
              <Card.Content className="p-6">
                ...
                <h3 className="mt-5 font-serif text-xl font-semibold text-ink">{service.name}</h3>
                <p className="mt-1 text-sm font-medium text-forest">{service.short}</p>
