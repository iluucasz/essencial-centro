...
export function AccessForm() {
  ...
  function handleSubmit(e: React.FormEvent) {
    e.preventDefault()
    // Demonstração: este conjunto tem só o site + login. Aponte para o destino real do seu
    // projeto (ex.: "/painel" para profissional e "/portal" para cliente) ao integrar a autenticação.
    router.push("/")
  }
