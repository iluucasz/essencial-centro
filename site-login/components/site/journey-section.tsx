...
import { JOURNEY_STEPS, DIFFERENTIALS } from "@/lib/clinic"
    ...
    <section id="jornada" className="scroll-mt-20 bg-forest py-20 text-cream sm:py-24">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="grid items-center gap-12 lg:grid-cols-2">
          <div>
            <span className="text-sm font-semibold uppercase tracking-[0.16em] text-clay-soft">
              Como funciona
            </span>
            ...
            <p className="mt-4 text-pretty text-lg leading-relaxed text-cream/75">
              Do primeiro atendimento aos resultados, tudo fica registrado e
              organizado. Você acompanha de onde começou, o que foi feito e o
              que já conquistou.
            </p>
